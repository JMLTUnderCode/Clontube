...
<body>
    ...
    <div class="contenedor-cuerpo">
        ...
        <div class="Menu-lateral" id="Menu_lateral">
            <div class="Secciones-de-Menu">
                <a href="./MainPage.php" class="Seccion-Menu selecionado" ><i class="ri-home-5-line" title="Inicio"></i>Inicio</a>
                ...
                <a href="./ListaReproduccion.php" class="Seccion-Menu"><i class="ri-play-list-2-fill" title="Listas de reproducción"></i>Listas de reproducción</a>
        ...
        <div class="Contenido" id="contenido_v">
            ...
            <div class="contenedor-videos" id="video_contenedor">
                <!-- Donde se insertan los videos bajo el script BUSCADOR-REPRODUCTOR -->
            </div>
        </div>
    </div>
    ...
    <!-- Script para habilitar buscador y reproduccion de youtube-->
    <script src="../js/scriptBuscadorReproductor.js"></script>
</body>
</html>